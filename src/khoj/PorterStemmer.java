...
public class PorterStemmer {
    ...
    private static String[][] step2pairs = {new String[]{"ational", "ate"},
    ...
    /**
     *
     * @param term String to be processed
     * @return return processed token
     */
    public static String processToken(final String term) {
        String token = term;
        if (term != null) {
            ...
            //    * if it does, extract the stem, and do NOT test
            //      any other suffix.
            //    * take the stem and make sure it has m > 0.
            //        * if it does, complete the step and do not
            //      test any others.
            ...
            // step 3
            // program this step. the rules are identical to
            //step 2 and you can use
            // the same helper method. you may also want a matrix here.
            token = suffixReplacementHelper(token, mGr0, step3pairs);
            // step 4
            // program this step similar to step 2/3, except now
            //the stem must have
            // measure > 1.
            token = suffixReplacementHelper(token, mGr1, step4pairs);
            // note that ION should only be removed if the suffix
            //is SION or TION,
            // which would leave the S or T.
            // as before, if one suffix matches, do not try any
            //others even if the
            ...
            if (token.endsWith("e")) {
                ...
                // all your code should change the variable token,
                //which represents
    ...
    /**
     *
     * @param term String for mapping.
     * @param m Pattern object
     * @param pairs matrix of suffices
     * @return Token after mapping suffices
     */
    private static String suffixReplacementHelper(final String term,
        final Pattern m, final String[][] pairs) {
        String token = term;
